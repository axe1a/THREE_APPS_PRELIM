...
if (isset($_POST['insertOfferBtn'])) {
	...
	if ($offerObj->checkExistingOffer($user_id, $proposal_id)) {
		$_SESSION['message'] = "You have already submitted an offer for this proposal. Only one offer per proposal is allowed.";
		$_SESSION['status'] = '400';
		header("Location: ../index.php");
	} else {
		if ($offerObj->createOffer($user_id, $description, $proposal_id)) {
			...
			$_SESSION['message'] = "An error occurred while submitting your offer. Please try again.";
			$_SESSION['status'] = '400';
			header("Location: ../index.php");
		}
	}
